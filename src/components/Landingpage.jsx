...
const Landingpage = () => {
  return (
    <div className="w-full h-[90vh] flex bg-[#eecbd7]">
      <div className="leftside w-1/2 h-full border-2 border-black flex flex-col items-center justify-center gap-[1.5vw]">
      ...
      <div className="rightside w-1/2 h-full border-2 border-black">
        <ImageCard
